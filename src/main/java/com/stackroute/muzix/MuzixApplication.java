...
@SpringBootApplication // annotation is used to mark a configuration class that declares one or mor
// e @Bean methods and also triggers auto-configuration and component scanning
